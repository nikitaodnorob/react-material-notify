...
const NotificationContainer = ({ children }) => {
    ...
    return (react_1.default.createElement(context_1.NotificationContext.Provider, { value: { state, dispatch } },
        children,
        react_1.default.createElement("div", { className: "react-material-notify__container" }, state.map((notification) => react_1.default.createElement(Notification_1.Notification, { notification: notification })))));
};
